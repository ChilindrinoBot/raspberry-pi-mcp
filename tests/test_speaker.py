...
class MuteTests(unittest.TestCase):
    ...
    def test_mute_success(self, mock_amixer: Mock) -> None:
        result = mute()
    ...
    def test_mute_amixer_error(self, mock_amixer: Mock) -> None:
        result = mute()
    ...
    def test_mute_missing_amixer(self, mock_amixer: Mock) -> None:
        result = mute()
...
class UnmuteTests(unittest.TestCase):
    @patch("server.audio.speaker._run_amixer", return_value=_make_result())
    def test_unmute_success(self, mock_amixer: Mock) -> None:
        result = unmute()
    ...
    @patch("server.audio.speaker._run_amixer", return_value=_make_result(returncode=1, stderr="Device not found"))
    def test_unmute_amixer_error(self, mock_amixer: Mock) -> None:
        result = unmute()
    ...
    @patch("server.audio.speaker._run_amixer", side_effect=RuntimeError("amixer is not installed."))
    def test_unmute_missing_amixer(self, mock_amixer: Mock) -> None:
        result = unmute()
...
class RunAmixerTests(unittest.TestCase):
    ...
    def test_run_amixer_raises_when_not_installed(self, mock_which: Mock) -> None:
